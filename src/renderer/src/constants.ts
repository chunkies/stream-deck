...
export const COMP_TYPE_LABELS = { button: 'btn', switch: 'sw', slider: 'slider', knob: 'knob', folder: 'folder' }

export const SLIDER_ACTION_TYPES = ['volume', 'scroll', 'hotkey', 'command', 'sequence']
export const SWITCH_ACTION_TYPES = ['builtin', 'hotkey', 'command', 'sequence', 'page']
...
export const ACTIVE_SWATCHES = ['#4f46e5','#7c3aed','#2563eb','#0891b2','#16a34a','#dc2626','#d97706','#ec4899','#f87171','#4ade80']
...
export const ALL_EMOJIS = [...new Set(Object.values(EMOJI_DATA).flat())]
