...
const musicPage: Page = {
  ...
  components: [
    ...
    { id: 'tpl-m-7', col: 1, row: 3, colSpan: 3, rowSpan: 1, componentType: 'tile', label: 'Now Playing', color: '#0f172a', pluginTileId: 'spotify', pluginTileEvent: 'spotify.nowPlaying', pluginTileField: 'track' },
  ],
}
