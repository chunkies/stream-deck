...
export const SLIDER_ACTION_TYPES = ['volume', 'scroll', 'hotkey', 'command', 'sequence'] as const
export const SWITCH_ACTION_TYPES = ['builtin', 'hotkey', 'command', 'sequence', 'page'] as const
