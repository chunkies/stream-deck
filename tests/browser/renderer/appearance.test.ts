...
import { initAppearanceEditor, setAppearanceFromComp, getAppearanceFields, updatePreviewNow } from '../../../src/renderer/src/appearance'
...
describe('setAppearanceFromComp', () => {
  ...
  test('image section hidden for spotify', () => {
    setAppearanceFromComp({}, 'spotify')
    const section = document.getElementById('ea-image-section') as HTMLElement
